...
# info: this is a script to launch other rofi.local/bin,
...
# search local files
COMMANDS["locate"]="~/.local/bin/rofi-locate.sh"
LABELS["locate"]=""

# open custom web searches
COMMANDS["websearch"]="~/.local/bin/rofi-surfraw-websearch.sh"
LABELS["websearch"]=""
...
# COMMANDS["#screenshot"]='/home/dka/bin/screenshot.local/bin/myscreenshot.sh'
...
function start()
{
    ...
    print_menu | sort | rofi -dmenu -mesg ">>> launch your collection of rofi.local/bin" -i -p "rofi-bangs: "
